...
import { Pencil, Save, Plus, LogOut, Settings, Layers, Monitor } from 'lucide-react';
      ...
      <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 top-full mt-2 w-56 bg-zinc-900/95 backdrop-blur-xl rounded-xl shadow-2xl border border-white/10 p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
            ...
            <button
              onClick={() => router.push('/app/console')}
              className="w-full flex items-center gap-2 px-3 py-2 text-zinc-300 hover:bg-white/10 rounded-lg transition-colors text-sm"
            >
